...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh)
{
	...
	do {
		...
		if (iResult > 0) {
			...
			char *res = draw_detections_string(im, l.w*l.h*l.n, thresh, boxes, probs, names, alphabet, l.classes);
			...
			iSendResult = send(ClientSocket, res, strlen(res), 0);
    ...
    while(1){
        ...
        get_region_boxes(l, 1, 1, thresh, probs, boxes, 0, 0);
        if (nms) do_nms_sort(boxes, probs, l.w*l.h*l.n, l.classes, nms);
		printf("%s", draw_detections_string(im, l.w*l.h*l.n, thresh, boxes, probs, names, alphabet, l.classes));
        save_image(im, "predictions");
        //show_image(im, "predictions");
